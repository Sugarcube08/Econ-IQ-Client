  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-6 text-center border border-dashed border-[#E3E2DF] rounded-xl bg-white/40 max-w-md mx-auto space-y-4 font-sans text-xs">
      ...
      <div className="space-y-1">
        <h4 className="font-headline text-sm font-bold text-[#111827] uppercase tracking-wide">
          {title}
        </h4>
        ...
        <div className="pt-2">
          {actionLink ? (
            ...
            <button
              ...
              className="px-4 py-2 bg-[#0F766E] text-white font-bold uppercase tracking-wider rounded hover:brightness-110 transition-colors shadow-sm cursor-pointer border-0"
            >
              {actionText}
            </button>
          )}
