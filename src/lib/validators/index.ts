...
export const DashboardOverviewSchema = z.object({
  ...
  sales_previous: z.number().optional().default(0),
  sales_delta: z.number().optional().default(0),
  collections_total: z.number().default(0),
  collections_previous: z.number().optional().default(0),
  collections_delta: z.number().optional().default(0),
  outstanding_exposure: z.number().default(0),
  outstanding_total: z.number().optional().default(0),
  outstanding_previous: z.number().optional().default(0),
  outstanding_delta: z.number().optional().default(0),
  overdue_exposure: z.number().optional().default(0),
  overdue_total: z.number().optional().default(0),
  overdue_previous: z.number().optional().default(0),
  overdue_delta: z.number().optional().default(0),
  health_index: z.number().default(0),
  commercial_health_index: z.number().optional().default(0),
  commercial_health_previous: z.number().optional().default(0),
  commercial_health_delta: z.number().optional().default(0),
  credit_limit_total: z.number().optional().default(0),
  organization_contribution_total: z.number().optional().default(0),
