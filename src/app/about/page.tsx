    ...
    <div className="space-y-24 py-16 px-6 lg:px-8 bg-background text-secondary">
      ...
      <section className="max-w-[1280px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-6">
          <span className="text-[10px] font-bold text-brand-accent uppercase tracking-wider block">Our Origin</span>
          <h3 className="font-headline text-2xl font-extrabold text-secondary tracking-tight">
        ...
        {/* Philosphy Box */}
        <div className="bg-secondary text-white p-8 md:p-12 rounded-xl border border-[#34485E] space-y-6">
      ...
      <section className="max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-white p-8 rounded-xl border border-outline-variant space-y-4">
          ...
          <h4 className="font-headline text-sm font-bold text-secondary uppercase tracking-wider">The Mission</h4>
        ...
        <div className="bg-white p-8 rounded-xl border border-outline-variant space-y-4">
          ...
          <h4 className="font-headline text-sm font-bold text-secondary uppercase tracking-wider">The Vision</h4>
          <p className="font-sans text-xs text-outline leading-relaxed">
        ...
        <div className="bg-white p-8 rounded-xl border border-outline-variant space-y-4">
          ...
          <h4 className="font-headline text-sm font-bold text-secondary uppercase tracking-wider">The Technology</h4>
          <p className="font-sans text-xs text-outline leading-relaxed">
      ...
      <section className="bg-white border border-outline-variant rounded-xl p-8 md:p-12 max-w-[1280px] mx-auto space-y-6">
        <div className="space-y-2">
          <span className="text-[10px] font-bold text-brand-accent uppercase tracking-wider block">Operational Integrity</span>
          <h3 className="font-headline text-lg font-bold text-secondary">Commitment to Accuracy</h3>
          <p className="font-sans text-xs text-outline leading-relaxed">
