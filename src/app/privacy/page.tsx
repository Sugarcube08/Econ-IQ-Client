    ...
    <div className="space-y-24 py-16 px-6 lg:px-8 bg-background text-secondary">
      ...
      <section className="max-w-3xl mx-auto bg-white border border-outline-variant rounded-xl p-8 md:p-12 font-sans text-xs sm:text-sm text-outline space-y-6 leading-relaxed">
        <div className="space-y-2">
          <h3 className="font-headline text-base font-bold text-secondary">1. Information Ingestion</h3>
          <p>
        ...
        <div className="space-y-2">
          <h3 className="font-headline text-base font-bold text-secondary">2. Tenant Isolation Boundaries</h3>
          <p>
        ...
        <div className="space-y-2">
          <h3 className="font-headline text-base font-bold text-secondary">3. Data Deletion</h3>
          <p>
        ...
        <div className="space-y-2">
          <h3 className="font-headline text-base font-bold text-secondary">4. Audits & Compliance</h3>
          <p>
