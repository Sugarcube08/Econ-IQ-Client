...
export default function OnboardingWizardPage() {
  ...
  if (!mounted) {
    return (
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="font-sans text-xs text-[#5E6266]">Initializing workspace...</p>
      </div>
    );
  }
  ...
  return (
    <div className="w-full max-w-[640px] bg-white border border-[#E3E2DF] rounded-xl shadow-md p-8 md:p-10 space-y-8 animate-fade-in text-[#243447]">
      {/* Progress Header */}
      <div className="space-y-4">
        <div className="flex justify-between items-center text-xs font-sans font-semibold text-[#5E6266] uppercase tracking-wider">
        ...
        <div className="w-full h-1.5 bg-[#E3E2DF] rounded-full overflow-hidden">
          <div
            className="bg-[#0F766E] h-full transition-all duration-500 ease-out"
              ...
              <span
                className={`w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-bold font-mono border transition-all ${
                  currentStep === s.num
                    ...
                    : 'bg-[#FAF9F6] text-[#5E6266] border-[#E3E2DF]'
                }`}
              >
                {s.num}
              </span>
              <span className={`text-[9px] uppercase font-bold tracking-wider hidden sm:inline ${
                currentStep === s.num ? 'text-[#0F766E]' : 'text-[#5E6266]'
              }`}>
                {s.label}
              </span>
            </div>
      ...
      <hr className="border-[#E3E2DF]/60" />

      {/* STEP 1: ORGANIZATION PROFILE */}
      {currentStep === 1 && (
        <div className="space-y-6 animate-fade-in text-xs font-sans">
          <div className="space-y-1">
            <h2 className="font-headline text-lg font-bold text-[#243447]">Organization Profile</h2>
            <p className="text-xs text-[#5E6266]">Establish your primary corporate record details.</p>
          </div>

          <div className="space-y-4">
            <div className="space-y-1.5">
              <label className="font-bold text-[#5E6266] uppercase tracking-wider block">Organization Name</label>
              <input
                type="text"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="font-bold text-[#5E6266] uppercase tracking-wider block">Industry</label>
                <select
              ...
              <div className="space-y-1.5">
                <label className="font-bold text-[#5E6266] uppercase tracking-wider block">Business Type</label>
                <select
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="font-bold text-[#5E6266] uppercase tracking-wider block">Country</label>
                <input
                  type="text"
              ...
              <div className="space-y-1.5">
                <label className="font-bold text-[#5E6266] uppercase tracking-wider block">State / Region</label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="font-bold text-[#5E6266] uppercase tracking-wider block">Primary Contact Person</label>
                <input
                  type="text"
              ...
              <div className="space-y-1.5">
                <label className="font-bold text-[#5E6266] uppercase tracking-wider block">Company Size</label>
                <select
      ...
      {currentStep === 2 && (
        <div className="space-y-6 animate-fade-in text-xs font-sans">
          <div className="space-y-1">
            <h2 className="font-headline text-lg font-bold text-[#243447]">Commercial Configuration</h2>
            <p className="text-xs text-[#5E6266]">Establish analysis windows and transaction currencies.</p>
          </div>

          <div className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="font-bold text-[#5E6266] uppercase tracking-wider block">Default Analysis Window</label>
                <select
              ...
              <div className="space-y-1.5">
                <label className="font-bold text-[#5E6266] uppercase tracking-wider block">Platform Currency</label>
                <select
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="font-bold text-[#5E6266] uppercase tracking-wider block">Reporting Frequency</label>
                <select
              ...
              <div className="space-y-1.5">
                <label className="font-bold text-[#5E6266] uppercase tracking-wider block">Operational Calendar</label>
                <select
      ...
      {currentStep === 3 && (
        <div className="space-y-6 animate-fade-in text-xs font-sans">
          <div className="space-y-1">
            <h2 className="font-headline text-lg font-bold text-[#243447]">Data Connectivity</h2>
            <p className="text-xs text-[#5E6266]">Establish data streams to compile continuous analytics.</p>
          </div>

          <div className="space-y-4">
            <div className="border border-[#E3E2DF] rounded-lg overflow-hidden divide-y divide-[#E3E2DF]">
              {/* Data Ingestion Row 1 */}
              <div className="p-4 flex items-center justify-between bg-[#FAF9F6]/30">
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <span className="material-symbols-outlined text-[18px] text-[#5E6266]">account_balance</span>
                ...
                <div className="flex items-center gap-3">
                  <span className={`px-2 py-0.5 rounded-full text-[9px] font-bold uppercase border ${
                    dataReadiness.erp === 'connected'
                      ...
                      : 'bg-outline-variant/20 border-outline-variant text-[#5E6266]'
                  }`}>
                  ...
                  {dataReadiness.erp === 'none' && (
                    <button
                      ...
                      className="px-3 py-1 bg-[#0F766E] text-white text-[10px] font-bold uppercase rounded hover:brightness-110 disabled:opacity-50 cursor-pointer"
                    >
              ...
              <div className="p-4 flex items-center justify-between bg-[#FAF9F6]/30">
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <span className="material-symbols-outlined text-[18px] text-[#5E6266]">sync</span>
              ...
              <div className="p-4 flex items-center justify-between bg-[#FAF9F6]/30">
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <span className="material-symbols-outlined text-[18px] text-[#5E6266]">receipt_long</span>
              ...
              <div className="p-4 flex items-center justify-between bg-[#FAF9F6]/30">
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <span className="material-symbols-outlined text-[18px] text-[#5E6266]">contacts</span>
            ...
            <div className="p-3 bg-[#0F766E]/5 rounded border border-[#0F766E]/20 text-[10px] leading-relaxed text-[#0f766e]">
      ...
      {currentStep === 4 && (
        <div className="space-y-6 animate-fade-in text-xs font-sans">
          <div className="space-y-1">
            <h2 className="font-headline text-lg font-bold text-[#243447]">Security Configuration</h2>
            <p className="text-xs text-[#5E6266]">Establish identity domains and provisioning parameters.</p>
          </div>

          <div className="space-y-4">
            <div className="space-y-1.5">
              <label className="font-bold text-[#5E6266] uppercase tracking-wider block">Admin Security Contact Email</label>
              <input
                type="email"
            ...
            <div className="p-4 bg-[#FAF9F6] rounded border border-[#E3E2DF] space-y-4">
              <span className="font-bold text-[#243447] uppercase tracking-wider block">Pre-Provisioned Access Scopes</span>
              ...
              <div className="space-y-3 font-sans text-xs">
                <div className="flex items-start gap-3">
                  ...
                  />
                  <div>
                    <strong className="text-[#243447]">Super Admin Role</strong>
                    <p className="text-[10px] text-[#5E6266] mt-0.5">Full access to billing, user invitations, and developer keys.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  />
                  <div>
                    <strong className="text-[#243447]">Risk Analyst Role</strong>
                    <p className="text-[10px] text-[#5E6266] mt-0.5">Read-only ledger analytics access with report exporting capability.</p>
                  </div>
                </div>
              </div>
            </div>

            <div className="flex items-center justify-between p-4 bg-[#FAF9F6] rounded border border-[#E3E2DF]">
              <div className="space-y-0.5">
                <strong className="text-[#243447] text-xs">Developer API Key Access</strong>
                <p className="text-[10px] text-[#5E6266]">Enable REST endpoints to support auto-checkout scoring</p>
              </div>
              <input
                type="checkbox"
                checked={securitySetup.apiAccess}
                onChange={(e) => updateSecuritySetup({ apiAccess: e.target.checked })}
                className="w-10 h-6 rounded-full accent-[#0F766E] cursor-pointer"
              />
            </div>
          </div>
        </div>
      ...
      {currentStep === 5 && (
        <div className="space-y-6 animate-fade-in text-xs font-sans">
          <div className="space-y-1">
            <h2 className="font-headline text-lg font-bold text-[#243447]">Review Configuration</h2>
            <p className="text-xs text-[#5E6266]">Confirm setup profile parameters before workspace launch.</p>
          </div>

          <div className="space-y-4 border border-[#E3E2DF] rounded-xl overflow-hidden font-sans text-xs">
            {/* Header banner */}
            <div className="bg-[#243447] text-white p-4 flex justify-between items-center">
              <div>
              ...
              <span className="text-[10px] bg-[#0F766E] text-white px-2 py-0.5 rounded font-mono font-bold">READY</span>
            </div>

            {/* Config summary details */}
            <div className="p-6 divide-y divide-[#E3E2DF]/60 space-y-4">
              <div className="grid grid-cols-2 gap-4 pb-2">
                <div>
                  <span className="text-[9px] text-[#5E6266] uppercase block font-bold">Primary Contact</span>
                  <span className="font-semibold">{orgProfile.primaryContact || 'N/A'}</span>
                </div>
                <div>
                  <span className="text-[9px] text-[#5E6266] uppercase block font-bold">HQ Region</span>
              ...
              <div className="grid grid-cols-2 gap-4 pt-4 pb-2">
                <div>
                  <span className="text-[9px] text-[#5E6266] uppercase block font-bold">Analysis Window</span>
                  <span className="font-semibold">{commercialConfig.windowDays} Days</span>
                </div>
                <div>
                  <span className="text-[9px] text-[#5E6266] uppercase block font-bold">Currency</span>
              ...
              <div className="grid grid-cols-2 gap-4 pt-4 pb-2">
                <div>
                  <span className="text-[9px] text-[#5E6266] uppercase block font-bold">ERP Connection</span>
                ...
                <div>
                  <span className="text-[9px] text-[#5E6266] uppercase block font-bold">API Access</span>
      ...
      {/* Navigation Controls */}
      <div className="flex justify-between items-center pt-4 border-t border-[#E3E2DF]/60">
        <button
          onClick={handleBack}
          disabled={currentStep === 1}
          className="px-5 py-2.5 border border-[#E3E2DF] text-xs font-semibold uppercase tracking-wider rounded hover:bg-[#FAF9F6] disabled:opacity-30 disabled:cursor-not-allowed cursor-pointer bg-white text-[#243447]"
        >
          Back
        </button>
        ...
        {currentStep === 5 ? (
          <button
            ...
            className="px-6 py-2.5 bg-[#0F766E] text-white text-xs font-bold uppercase tracking-wider rounded hover:brightness-110 active:scale-[0.98] transition-all shadow-sm cursor-pointer"
          >
